...
Выжны отступы слева перед именем поля и соотношение отступов. Именно отступы задают структуру.
...
slug: путь к странице на латиннице, начинающийся с обратного слэша. Если надо, то язык `ru` или `uk` автоматически добавляется к пути во время компиляции сайта.
