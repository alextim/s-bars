...
Шаг 3. Синхронизируйте локальный репозитоий с данными с удаленным защищенным

```bush
git push
```

Шаг 4. Обновление подмодуля данных в репозитории с кодом из удаленного защищенного репозитория с данными.
...
Шаг 5. Обновление подмодуля данных в репозитории с кодом.
