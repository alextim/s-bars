...
- [Инсталляция](#инсталляция)
  ...
  - [Пошаговая инструкция](#пошаговая-инструкция)
    - [Насторойка **Git** для работы с подмодулями](#насторойка-git-для-работы-с-подмодулями)
...
- [Публикация изменений](#публикация-изменений)
  ...
  - [Обновление главного репозитория с кодои](#обновление-главного-репозитория-с-кодои)
...
Инструкция по инсталляция рассчитана на пользователя умеющего пользоваться командной строкой.
...
#### Насторойка **Git** для работы с подмодулями
...
### Обновление главного репозитория с кодои
