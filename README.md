...
| ----------------- | ---------| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| metaTitle         | до 50-60 символов, строка на экране будет обрезана визуально до 600px | Главная ключевая фраза Второстепенная ключевая фраза \| Ваш бренд<br>Уникальный для каждой страницы сайта.    | [What is a meta title tag?](https://moz.com/learn/seo/title-tag), [Create good titles and snippets in Search Results](https://support.google.com/webmasters/answer/35624?hl=en) | Если **metaTitle** отсутствует, то поле **title** будет использовано          |
| metaDescription   | 50-160 символов  | 1 параграф из 1-2 предложений. Без кавычек `"` и спецсимволов.<br>Уникальный для каждой страницы сайта.      | [What is a meta description?](https://moz.com/learn/seo/meta-description), [How to create the right meta description](https://yoast.com/meta-descriptions/)                     | Если **metaDescription** отсутствует, то поле **description** будет использовано |
...
```yaml
---
title: Заголовок страницы. Обязательное поле. Уникальный для каждой страницы сайта. По возможности в одно короткое предложение.
...
# Если есть, то уникальный для каждой страницы сайта.
