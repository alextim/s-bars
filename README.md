...
- **contactsSlug**
Aдрес страницы контакты. Предустановлено `/contacts`. Нужно для SEO: микроразметка для Организации выводится только для двух страниw: "Главная" и "Контакты".
...
| currenciesAccepted  | SEO                           | [валюты, принимаемая к оплате](https://schema.org/currenciesAccepted)
| paymentAccepted     | SEO                           | [способы оплаты](https://schema.org/paymentAccepted)
...
```yaml
legalName: Компанія «Сніговий Барс»
