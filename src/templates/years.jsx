...
const YearTemplate = ({ path, data, pageContext: { locale, year, currentPage, numPages } }) => {
...
export const pageQuery = graphql`
  query yearQuery($locale: String!, $year: Int, $skip: Int!, $limit: Int!) {
    page: markdownRemark(fields: { slug: { regex: "/years$/" }, locale: { eq: $locale } }) {
      ...PageFragment
    }
    posts: allMarkdownRemark(
      ...
      filter: { fields: { year: { eq: $year }, locale: { eq: $locale } } }
    ) {
      edges {
        node {
          ...PostCardFragment
