...
import sendData from '@/components/Form/src/services/send-data';

import useModal from '@/components/Form/src/components/Modal/useModal';
...
const InquiryForm = () => {
  ...
  const onSubmitForm = async (data) => {
    ...
    try {
      ...
      /* leave modal open */
      /**
       * closeModal(0);               // close immediately
